...
module.exports.homelist = function(req, res){
 ...
 // Adding New item by POST method
  ...
  // Getting the food Item 
   module.exports.edit_Data = function(req, res){
    ...
    request(
      ...
      function(err, response, body) {
        ...
        data = body;
        if (response.statusCode === 200 && data) {
          data[0].date = Date_Format(data[0].date);
          if (data[0].expiry){
            data[0].expiry = Date_Format(data[0].expiry);
          }
          res.render('food-create-edit', {
            title: 'Edit Food',
            create: false,
  ...
  // Update food item by PUT
  module.exports.update_Item = function(req, res){
